...
class Dailywork_Form_FrmProject extends Zend_Form
{
	...
	public function add($data=null){
		$_project= new Zend_Dojo_Form_Element_TextBox('project');
		$_project->setAttribs(array('required'=>'true','missingMessage'=>'Invalid Module!','class'=>'form-control validate[required]',
		...
		$this->addElements(array($_project,$_status));
		return $this;
